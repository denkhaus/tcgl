...
func localDo(method string, ts *httptest.Server, path string, hdr Hdr, body []byte) ([]byte, os.Error) {
	// First prepare it.
	tr := &http.Transport{}
...
func TestGetXML(t *testing.T) {
	// Prepare the server.
	AddResourceHandler("test", "getxml", NewLoggingHandler("xml"))
...
func TestGetJSON(t *testing.T) {
	// Prepare the server.
	AddResourceHandler("test", "getjson", NewLoggingHandler("json"))
